...
public class AdventOfCode3 {
        ...
        for (int i = 0; i < inputArr.size(); i++) {
            ...
            for (int j = 0; j < row.length; j++) {
                if (isNumber(row[j])) {
                    ...
                    boolean isPossible = isAdjacentSymbol(i, j, j - 1 + Integer.toString(num).length() ,inputArr);
                    if (isPossible){
                        rs += num;
    ...
    public static boolean isAdjacentSymbol(int rowNum, int from, int to,  List<char[]> inputArr){
